...
function EmailViewer() {
  ...
  const {windowWidth} = useContext(SharedContext);
  ...
  const {view, setView} = useContext(SharedContext);
              ...
              null
                ...
                <List component='nav' aria-label='main mailbox folders' // https://material-ui.com/components/lists/#lists
                  style={{maxHeight: '100vh',
                    maxWidth: windowWidth, overflow: 'auto'}}>
                  <ListItem>
                  ...
                  <ListItem>
                    <Avatar alt={from.toUpperCase()} src={avatar}/>
                    <ListItemText
